...
public class CarDealership {
     ...
     * Initializes cars array list, the sales team object, and the accounting system
     * object.
    ...
    /**
     * Takes array list of cars and adds every car object in the list to the car
     * dealership's cars array list
     * 
    ...
    /**
     * Takes a VIN and searches through the cars array list for a matching VIN, if
     * found, remove it.
     * Generates a random sales member and a random date and calls the accounting
     * system add method
    ...
    /**
     * Takes a transaction ID and attempts to add a previously bought car back to
     * the accounting system transaction list.
     * Generates a random later date in the month than the date the car was bought
     * in.
     * 
     * @param transactionID transaction ID to search for
     * @return error message if car was already returned
     *         string representation of the transaction if the car has not yet been
     *         returned
     */
     ...
     * Method displays string representation of car objects depending on the values
     * of
     * the electric, AWD, and price filters.
     */
    public void displayInventory() {
        System.out.println();
        System.out.printf("%s    %s  %s   %s    %s %s  %s  %s     %s    %s   %s\n", "#", "VIN", "Manufacturer", "Color",
                "Model", "Range", "Safety", "Powertrain", "Price", "Chg. Time", "Battery Type");
