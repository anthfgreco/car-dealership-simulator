...
public class ElectricCar extends Car{
     ...
     */
    public ElectricCar(String mfr, String color, int power, int numWheels, int ELECTRIC_MOTOR, int GAS_ENGINE, Model model, int maxRange, double safetyRating, String AWD, double price, int rechargeTime, String batteryType){
